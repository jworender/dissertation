...
\begin{table}[p]
    ...
    \begin{tabularx}{0.98\textwidth}{>{\RaggedRight\arraybackslash}p{0.14\textwidth}>{\RaggedRight\arraybackslash}p{0.14\textwidth}>{\RaggedRight\arraybackslash}p{0.13\textwidth}>{\RaggedRight\arraybackslash}p{0.15\textwidth}>{\RaggedRight\arraybackslash}p{0.14\textwidth}>{\RaggedRight\arraybackslash}X}
...
\begin{table}[p]
    \ContinuedFloat
    \caption[]{Cross-family positioning of the dissertation pipeline relative to the main competing method families discussed in this chapter (continued).}
    \centering
    \setlength{\tabcolsep}{2pt}
    \renewcommand{\arraystretch}{0.95}
    \begin{tabularx}{0.98\textwidth}{>{\RaggedRight\arraybackslash}p{0.14\textwidth}>{\RaggedRight\arraybackslash}p{0.14\textwidth}>{\RaggedRight\arraybackslash}p{0.13\textwidth}>{\RaggedRight\arraybackslash}p{0.15\textwidth}>{\RaggedRight\arraybackslash}p{0.14\textwidth}>{\RaggedRight\arraybackslash}X}
