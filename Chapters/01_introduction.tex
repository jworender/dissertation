...
\begin{itemize}
    \item \textbf{Predictive discrimination:} metrics such as the area under the receiver operating characteristic (ROC) curve (AUC) and Youden's J-index at operational thresholds, interpreted in dataset context \autocites{JOrender2025Efficient,shin2020,sigillito1989}.
