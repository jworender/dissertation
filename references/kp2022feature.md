...
- Chapter: `Related Work`; Section: `Group, Block, and Ordered Sparsity`; Line: `Chapters/03_relatedwork.tex:43`; Relevance: Cited to support the statement that Recent hybrid ranking-plus-search pipelines also perform well in domain-specific settings.
